...
'''
rede = buildNetwork(2, 3, 1, outclass=SoftmaxLayer, hiddenclass=SigmoidLayer, bias=False) # (camada de entrada, camada oculta, camada de saída)
print(rede['in'])
print(rede['hidden0'])
print(rede['out'])
print(rede['bias'])
...
base = SupervisedDataSet(2, 1) # 2 atributos previsores e 1 classe
